...
// ---------------------------------------------------
// Horizontal Canvas Navigation (Left / Center / Right)
// ---------------------------------------------------
...
function updateHorizontalView() {
  ...
  if (currentView === "left") {
    // show left page
    canvas.style.transform = "translateX(0vw)";
    leftPage && leftPage.classList.add("active");
    rightPage && rightPage.classList.remove("active");
  } else if (currentView === "right") {
    // show right page
    canvas.style.transform = "translateX(-200vw)";
    rightPage && rightPage.classList.add("active");
    leftPage && leftPage.classList.remove("active");
  } else {
    // show center (hero + long scroll)
...
// Hotzone triggers
if (hotzoneLeft) {
  hotzoneLeft.addEventListener("click", () => {
    currentView = currentView === "left" ? "center" : "left";
    updateHorizontalView();
  });
}

if (hotzoneRight) {
  hotzoneRight.addEventListener("click", () => {
    currentView = currentView === "right" ? "center" : "right";
    updateHorizontalView();
  });
}
...
// Ensure we start on the center panel
updateHorizontalView();
